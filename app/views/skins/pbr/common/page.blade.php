...
<head>
	...
	<link href="{{ View::asset('css/bootstrap.css') }}" rel="stylesheet" />
...
<body data-toggle="ajax" data-context="{{ $context }}">
	<div class="loader">
		@include('skins.pbr.common.loader')
	</div>
	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{{ url() }}"><img src="{{ View::asset('img/sas-logo-wht.png') }}" alt="SAS"/>{{ $site->general->title }}</a>
			</div>
